...
public interface ApiInterface {
    ...
    Call<ResourceResponse> getBoardResources(@Header("Accept") String accept, @Header("Authorization") String auth, @Path("board_id") int categoryId, @Path("standard_id") int standardId, @Path("subject_id") int subjectId, @Path("resource_type_id") int resourceTypeId);


    @GET("resources/{resource_type_id}/{standard_id}/{subject_id}")
    Call<ResourceResponse> getOtherResources(@Header("Accept") String accept, @Header("Authorization") String auth, @Path("resource_type_id") int resourceTypeId, @Path("standard_id") int standardId, @Path("subject_id") int subjectId);


    @GET("resourceTypes/{standard_id}/{subject_id}")
    Call<ResourceTypeResponse> getResourceTypes(@Header("Accept") String accept, @Header("Authorization") String auth, @Path("standard_id") int standardId, @Path("subject_id") int subjectId);


    @GET("subjects/{standard_id}")
    Call<SubjectResponse> getSubjects(@Header("Accept") String accept, @Header("Authorization") String auth, @Path("standard_id") int standardId);


    @GET("subjects/{standard_id}")
    Call<StreamResponse> getStreams(@Header("Accept") String accept, @Header("Authorization") String auth, @Path("standard_id") int standardId);


    @GET("standards")
    Call<StandardResponse> getStandards(@Header("Accept") String accept, @Header("Authorization") String auth);


    @GET("home")
    Call<HomeResponse> getHomeResponse(@Header("Accept") String accept, @Header("Authorization") String auth);
